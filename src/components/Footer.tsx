  ...
  return (
    <FooterContainer>
      <FooterContent>
        <FooterGrid>
          <FooterSection>
            <FooterLogo>La<span>Duquesa</span>Dev</FooterLogo>
          ...
          <FooterSection>
            ...
            <FooterNav>
              <FooterLink href="/#projects">{t("nav.portfolio")}</FooterLink>
        ...
        <Copyright>
          <span>© {currentYear} Yulimar Duque. {t("footer.rights")}</span>
          <span>yduquedealba@gmail.com</span>
        </Copyright>
      </FooterContent>
    </FooterContainer>
  )
